...
app.use(cors({
  origin: function (origin, callback) {
    ...
    // Permetti richieste senza origin (es. Postman, mobile apps, file://)
...
// Rotte per disponibilità (endpoint per gestori)
...
console.log('🔧 Tentativo di avvio server...');
console.log('🔧 Porta configurata:', PORT);

app.listen(PORT, () => {
  console.log(`✅ Backend server running on port ${PORT}`);
  console.log('🚀 Server avviato senza cron job (temporaneamente disabilitato)');
}).on('error', (err) => {
